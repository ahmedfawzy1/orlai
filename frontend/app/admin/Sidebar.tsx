...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static w-64 h-full bg-white border-r flex flex-col justify-between z-50 shadow-2xl transition-transform duration-300 ease-in-out rounded-r-2xl
